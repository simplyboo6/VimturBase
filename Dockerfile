...
COPY --from=build /usr/include/png.h /usr/include/png.h
COPY --from=build /usr/include/jpeglib.h /usr/include/jpeglib.h
COPY --from=build /usr/include/tiffio.h /usr/include/tiffio.h
